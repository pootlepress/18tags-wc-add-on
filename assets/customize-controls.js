...
(function( exports, $ ){
	...
	$( document ).ready( function () {
		var $blog_layout = $( '#input_wc-18-tags-blog-layout' ),
			$grid = $('#customize-control-wc-18-tags-blog-grid' ),
			$post_content = $( 'select[data-customize-setting-link="wc-18-tags-blog-content"]' ),
			$excert_fields = $(
				'#customize-control-wc-18-tags-blog-excerpt-count,' +
				'#customize-control-wc-18-tags-blog-excerpt-end,' +
				'#customize-control-wc-18-tags-blog-rm-butt-text'
			);
