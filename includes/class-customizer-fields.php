 ...
 */
final class WooCommerce_18_Tags_Customizer_Fields extends WooCommerce_18_Tags_Abstract {
	/**
	 ...
	 * @global array $wc_18_tags_customizer_fields
	 */
	public function etp_customize_register( $wp_customize ) {
		global $wc_18_tags_customizer_fields;

		$sections = array();
		foreach ( $wc_18_tags_customizer_fields as $f ) {
	...
	public function cool_fields( WP_Customize_Manager $wp_customize, $type, $id, $args ){
		...
		if ( in_array( $type, array( 'multi-checkbox', 'grid', ) ) ) {
			$field_class = 'WC18T_Custom_Customize_Control';
