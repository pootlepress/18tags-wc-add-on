...
/**
 * WooCommerce_18_Tags_WooCommerce Class
 *
 * @class WooCommerce_18_Tags_WooCommerce
 * @version	1.0.0
 * @since 1.0.0
 * @package	WooCommerce_18T
 */
class WooCommerce_18_Tags_WooCommerce extends WooCommerce_18_Tags_WooCommerce_Shop {
	...
	public function its_product() {
		...
		if ( 'full' == $this->get( 'wc-product-layout', 'default' ) ) {
			...
			$this->css .= '.wc-18-tags-active.right-sidebar .content-area{ width: auto; margin: auto; }';
		}
	...
	private function distraction_free_checkout() {
		...
		if ( $this->get( 'wc-co-distraction-free' ) ) {
			...
			remove_action( 'eighteen_tags_sidebar', 'eighteen_tags_get_sidebar' );
			$css .= '.wc-18-tags-active.right-sidebar .content-area{ width: auto; margin: auto; }';
