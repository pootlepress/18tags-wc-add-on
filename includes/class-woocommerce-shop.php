<?php
/**
 * WooCommerce_18_Tags_WooCommerce_Shop Class
 *
 * @class WooCommerce_18_Tags_WooCommerce_Shop
 * @version	1.0.0
 * @since 1.0.0
 * @package	WooCommerce_18T
 */
class WooCommerce_18_Tags_WooCommerce_Shop extends WooCommerce_18_Tags_Abstract {
	...
	protected function its_product_archive() {
		...
		if ( in_array( $this->get( 'wc-shop-layout', 'default' ), array( 'full', 'masonry', ) ) ) {
			...
			$this->css .= '.wc-18-tags-active #primary.content-area{ width: 100%; margin: auto; }';
		}
	...
	public function shop() {
		...
		//Shop alignment
		$this->css .=
			'.wc-18-tags-active ul.products li.product { ' .
